...
MATERIAL_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "potential_reinforcer_set": {
        ...
        "quickPicksByField": {
            "mand3_people": ["爸爸", "妈妈", "老师", "治疗师", "爷爷", "奶奶"],
            "mand3_settings": ["屋里", "屋外", "教室", "游戏区", "桌面", "走廊"],
            "mand3_examples_default": ["红瓶泡泡", "蓝瓶泡泡", "大球", "小球", "红车", "蓝车"],
            "mand3_examples_bubbles": ["红瓶泡泡", "蓝瓶泡泡", "大瓶泡泡", "小瓶泡泡"],
            "mand3_examples_ball": ["红球", "蓝球", "大球", "小球"],
            "mand3_examples_car": ["红车", "蓝车", "大车", "小车"],
            "mand3_examples_music": ["儿歌", "音乐玩具", "快音乐", "慢音乐"],
            "mand3_examples_slinky": ["大彩虹弹簧", "小彩虹弹簧", "红色弹簧", "蓝色弹簧"],
            "mand3_examples_swing": ["室内秋千", "户外秋千", "大秋千", "小秋千"],
        },
