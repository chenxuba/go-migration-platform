...
PROVISION_PEP3_DATA_DIR="${PROVISION_PEP3_DATA_DIR:-$DEPLOY_APP_ROOT/current/docs}"
PROVISION_ERXIN_DATA_DIR="${PROVISION_ERXIN_DATA_DIR:-$DEPLOY_APP_ROOT/current/docs}"
...
PEP3_DATA_DIR=$PROVISION_PEP3_DATA_DIR
ERXIN_DATA_DIR=$PROVISION_ERXIN_DATA_DIR
