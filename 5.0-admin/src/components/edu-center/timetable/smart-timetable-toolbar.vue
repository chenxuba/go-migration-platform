...
<template>
  <div class="time-template mt2 bg-white py3 px5 rounded-4 rounded-lb-0 rounded-rb-0">
    <div class="top-filter st-top-filter-bar">
      <div class="st-top-filter-bar__inner">
        <div class="st-top-filter-bar__left">
          <div class="shrink-0">
        ...
        <div class="time-selector st-top-filter-bar__center">
          <div
        ...
        <div class="st-top-filter-bar__right">
          <a-select
...
.st-top-filter-bar__inner {
  display: grid;
  grid-template-columns: max-content minmax(8px, 1fr) auto minmax(8px, 1fr) max-content;
  align-items: center;
  width: max-content;
  min-width: 100%;
  column-gap: 6px;
...
.st-top-filter-bar__left,
.st-top-filter-bar__right {
  display: flex;
  align-items: center;
