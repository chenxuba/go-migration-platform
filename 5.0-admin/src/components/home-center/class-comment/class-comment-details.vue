...
const { selectedValues, columnOptions, filteredColumns, totalWidth }
  = useTableColumns({
    storageKey: 'class-comment-details', // 本地存储键名
    allColumns, // 原始列配置
          ...
          >
            ...
            <template #bodyCell="{ column, record }">
              ...
              <template v-if="column.key === 'isComment'">
                <span class="bg-#e6ffec text-#0c3 text-3 px2 py1 rounded-10">未点评</span>
              </template>
              ...
              <template v-if="column.key === 'feedbackComment'">
                <div class="text-#222">
                  -
                </div>
              </template>
              ...
              <template v-if="column.key === 'action'">
                <a-space :size="14">
                  <a class="font500">去点评{{ record.a }}</a>
                  <a class="font500">查看{{ record.a }}</a>
                </a-space>
              </template>
            </template>
          </a-table>
