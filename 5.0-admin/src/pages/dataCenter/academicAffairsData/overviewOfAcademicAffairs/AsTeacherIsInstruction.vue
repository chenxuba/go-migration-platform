...
const allColumns = ref([
  ...
  {
    title: '补课消耗学费金额',
    dataIndex: 'makeupTuitionAmount',
    key: 'makeupTuitionAmount',
    width: 160,
    sorter: (a, b) => a.makeupTuitionAmount - b.makeupTuitionAmount,
  },
])
// 表格数据
