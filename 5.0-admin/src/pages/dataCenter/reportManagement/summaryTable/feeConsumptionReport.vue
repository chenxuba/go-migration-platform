...
const classDimension = [
  ...
  { label: '班主任', value: 1 },
  { label: '已用数量', value: 2, tooltip: '学员在所选时间和维度内消耗的课时、金额（含赠送）' },
  { label: '已用学费', value: 3, tooltip: '学员在所选时间和维度内消耗的学费总和' },
]
// 课程维度指标
const courseDimension = [
  { label: '课程名称', value: 0, disabled: true },
  { label: '已用数量', value: 1, tooltip: '学员在所选时间和维度内消耗的课时、金额（含赠送）' },
  { label: '已用学费', value: 2, tooltip: '学员在所选时间和维度内消耗的学费总和' },
]
// 教师维度指标
const teacherDimension = [
  { label: '教师名称', value: 0, disabled: true },
  { label: '已用数量', value: 1, tooltip: '学员在所选时间和维度内消耗的课时、金额（含赠送）' },
  { label: '已用学费', value: 2, tooltip: '学员在所选时间和维度内消耗的学费总和' },
  { label: '教师记录课时', value: 3 },
  { label: '助教记录课时', value: 4 },
  { label: '学员总数', value: 5 },
  { label: '到课学员', value: 6 },
  { label: '请假学员', value: 7 },
  { label: '旷课学员', value: 8 },
...
// 学员维度指标
const studentDimension = [
  { label: '学员姓名', value: 0, disabled: true },
  { label: '已用数量', value: 1, tooltip: '学员在所选时间和维度内消耗的课时、金额（含赠送）' },
  { label: '已用学费', value: 2, tooltip: '学员在所选时间和维度内消耗的学费总和' },
]
