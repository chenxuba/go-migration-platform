...
const classDimension = [
  ...
  { label: '班主任', value: 1 },
  { label: '在读人数', value: 2, tooltip: '即当前班级内有报读课程有一门或多门课程，且课程未结课的学员' },
  { label: '满班人数', value: 3, tooltip: '班级设置的满班学员人数' },
  { label: '满班率', value: 4, tooltip: '该班级的在读人数 / 满班人数 * 100%' },
  { label: '开课次数', value: 5, tooltip: '时间段内的上课记录总数' },
  { label: '实到人次', value: 6, tooltip: '实际记录为到课状态的学员人次总和（支持配置是否包含试听、补课、临时学员）' },
  { label: '应到人次', value: 7, tooltip: '上课记录中所有学员的人次总和（支持配置是否包含试听、补课、临时学员）' },
  { label: '出勤率', value: 8, tooltip: '实到人次 / 应到人次 * 100%' },
  { label: '学费欠费人次', value: 9, tooltip: '时间段内学员欠费上课未清算人次' },
  { label: '学费欠费数量', value: 10, tooltip: '时间段内学员欠费上课的拖欠课时数' },
]

// 教师维度指标
const teacherDimension = [
  { label: '教师姓名', value: 0, disabled: true },
  { label: '当前带班数量', value: 1 },
  { label: '当前带班人数', value: 2 },
  { label: '实到人次', value: 3, tooltip: '实际记录为到课状态的学员人次总和（支持配置是否包含试听、补课、临时学员）' },
  { label: '应到人次', value: 4, tooltip: '上课记录中所有学员的人次总和（支持配置是否包含试听、补课、临时学员）' },
  { label: '出勤率', value: 5, tooltip: '实到人次 / 应到人次 * 100%' },
  { label: '学费欠费人次', value: 6, tooltip: '时间段内学员欠费上课未清算人次' },
  { label: '学费欠费数量', value: 7, tooltip: '时间段内学员欠费上课的拖欠课时数' },
]
