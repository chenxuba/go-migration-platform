...
const reportList = [
  {
    ...
    popover_content: '订单实收金额<br />时间：订单经办时间<br />条件：订单状态为待处理与已完成状态',
    chain: '',
    onYear: '',
  },
  {
...
const allColumns = ref([
  ...
  {
    title: '业绩分配记录数',
    dataIndex: 'performanceRecords',
    key: 'performanceRecords',
    width: 160,
    sorter: (a, b) => a.performanceRecords - b.performanceRecords,
  },
  {
    title: '已分配业绩金额',
...
const dataSource = ref([
  {
    ...
    performanceRecords: 15,
    allocatedAmount: 11500,
  },
  {
    employeeName: '李四',
    employmentStatus: '在职',
    creationTime: '2023-01-15',
    performanceRecords: 18,
    allocatedAmount: 14200,
  },
  {
    employeeName: '王五',
    employmentStatus: '离职',
    creationTime: '2022-10-01',
    performanceRecords: 12,
