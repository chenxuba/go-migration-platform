...
const reportList = [
  {
    ...
    popover_title: '期内在读学员数', // 弹出框标题
    popover_content: '所选时间段内的在读学员数量', // 弹出框内容
    chain: '', // 环比
    onYear: '', // 同比
  },
  {
    ...
    value: 4,
    briefing: true,
    popover_title: '期末在读学员数',
    popover_content: '所选时间段结束时的在读学员数量',
    chain: '',
    onYear: '',
  },
  {
  ...
  },
  {
    ...
    briefing: true,
    popover_title: '学员流失率',
    popover_content: '流失学员数/期内在读学员数 *100%',
    chain: '',
    onYear: '',
  },
]
