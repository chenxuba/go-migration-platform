...
export const PlatformAccessEnum = {
  ...
  scaleManage: route('page:sysScale', '系统配置', '量表管理'),
  scaleManageAdd: action('perm:sysScaleAdd', '系统配置', '量表管理', '新增量表'),
  scaleManageEdit: action('perm:sysScaleEdit', '系统配置', '量表管理', '编辑量表'),
  scaleManagePublish: action('perm:sysScalePublish', '系统配置', '量表管理', '发布版本'),
  scaleManageAuth: action('perm:sysScaleAuth', '系统配置', '量表管理', '机构授权'),
