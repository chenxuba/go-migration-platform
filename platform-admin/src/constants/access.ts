...
export const PlatformAccessEnum = {
  ...
  dict: route('page:sysDict', '系统配置', '字典管理'),
  dictAdd: action('perm:sysDictAdd', '系统配置', '字典管理', '新增字典'),
  dictEdit: action('perm:sysDictEdit', '系统配置', '字典管理', '编辑字典'),
  dictDelete: action('perm:sysDictDel', '系统配置', '字典管理', '删除字典'),
  dictValueAdd: action('perm:sysDictValueAdd', '系统配置', '字典管理', '新增字典项'),
  dictValueEdit: action('perm:sysDictValueEdit', '系统配置', '字典管理', '编辑字典项'),
  dictValueDelete: action('perm:sysDictValueDel', '系统配置', '字典管理', '删除字典项'),
