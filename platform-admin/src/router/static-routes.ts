...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/platform/scales/pep3-iep-materials/import',
    name: 'PlatformPEP3IEPMaterialImport',
    component: () => import('~/pages/platform/scales/pep3-iep-materials/import-starter.vue'),
    meta: {
      title: '导入PEP3 IEP素材库',
      access: [PlatformAccessEnum.scaleManageIepTarget],
      hideInMenu: true,
      hideInBreadcrumb: true,
      parentKeys: ['/platform/scales/pep3-iep-materials'],
    },
  },
  {
    path: '/platform/scales/pep3-iep-materials/import/edit/:id',
    name: 'PlatformPEP3IEPMaterialImportEdit',
    component: () => import('~/pages/platform/scales/pep3-iep-materials/import-edit.vue'),
    meta: {
      title: '处理PEP3素材导入',
      access: [PlatformAccessEnum.scaleManageIepTarget],
      hideInMenu: true,
  ...
  {
    path: '/platform/scales/pep3-iep-materials/import/record',
    name: 'PlatformPEP3IEPMaterialImportRecord',
    component: () => import('~/pages/platform/scales/pep3-iep-materials/import-record.vue'),
    meta: {
      title: 'PEP3素材导入记录',
      access: [PlatformAccessEnum.scaleManageIepTarget],
      hideInMenu: true,
  ...
  {
    path: '/platform/scales/pep3-iep-materials/import/record/:id',
    name: 'PlatformPEP3IEPMaterialImportRecordDetail',
    component: () => import('~/pages/platform/scales/pep3-iep-materials/import-record-detail.vue'),
    meta: {
      title: 'PEP3素材导入详情',
      access: [PlatformAccessEnum.scaleManageIepTarget],
      hideInMenu: true,
