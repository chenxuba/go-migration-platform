...
const defaultDimension = [
  { label: '所属机构', value: '1' },
  { label: '总账户 ID', value: '2' },
  { label: '上课记录 ID', value: '3' },
  { label: '子账户变动记录 ID', value: '4' },
  { label: '变动时间', value: '5' },
  { label: '变动学员', value: '6' },
  { label: '学员手机号', value: '7' },
  { label: '学员基本信息', value: '8', hasSubDimension: true, subDimensionKey: 'studentInfo' },
  { label: '学员自定义属性', value: '9' },
  { label: '学员关联人员信息', value: '10', hasSubDimension: true, subDimensionKey: 'studentRelation' },
  { label: '扣费课程总账户名', value: '11' },
  { label: '关联班级', value: '12' },
  { label: '一对一', value: '13' },
  { label: '课程类别', value: '14' },
  { label: '课程自定义属性', value: '15', hasSubDimension: true, subDimensionKey: 'courseCustom' },
  { label: '科目', value: '16' },
  { label: '课程模板', value: '17' },
  { label: '授课方式', value: '18' },
  { label: '收费方式', value: '19' },
  { label: '变动类型', value: '20' },
  { label: '变动数量', value: '21' },
  { label: '变动数量对应学费', value: '22' },
  { label: '关联订单编号', value: '23' },
  { label: '关联子订单号', value: '24' },
]
