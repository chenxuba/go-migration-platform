...
const allColumns = ref([
  ...
  {
    title: '归属意向学员数',
    dataIndex: 'assignedIntentStudents',
    key: 'assignedIntentStudents',
    width: 160,
    sorter: (a, b) => a.assignedIntentStudents - b.assignedIntentStudents,
  },
  {
    title: '新增意向学员数',
  ...
  {
    title: '已分配业绩金额',
    dataIndex: 'allocatedPerformanceAmount',
    key: 'allocatedPerformanceAmount',
    width: 160,
    sorter: (a, b) => a.allocatedPerformanceAmount - b.allocatedPerformanceAmount,
  },
])
// 表格数据
const dataSource = ref([
  {
    ...
    allocatedPerformanceAmount: 5750,
  },
  {
    salesName: '李四',
    employmentStatus: '在职',
    creationTime: '2023-01-02',
    assignedIntentStudents: 40,
    ...
    allocatedPerformanceAmount: 7100,
  },
  {
    salesName: '王五',
    employmentStatus: '离职',
    creationTime: '2023-01-03',
    assignedIntentStudents: 38,
    newIntentStudents: 28,
    followUpRecords: 45,
    unvisitedFollowUpRecords: 18,
    visitedFollowUpRecords: 27,
    overdueUnvisitedRecords: 6,
    trialInvitations: 20,
    completedTrials: 16,
    ...
    allocatedPerformanceAmount: 6400,
  },
])
// 图表数据源
