...
func (handler *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/instChannel/getDefaultChannelList", handler.defaultChannels)
	mux.HandleFunc("/instChannel/getChannelList", handler.channels)
	mux.HandleFunc("/instChannel/getChannelListWithChannels", handler.channelsWithGroups)
	mux.HandleFunc("/instChannel/getChannelPCPage", handler.channelPCPage)
	mux.HandleFunc("/instChannel/getChannelTree", handler.channelTree)
	mux.HandleFunc("/instChannel/updateChannelStatus", handler.updateChannelStatus)
	mux.HandleFunc("/instChannel/saveChannel", handler.addChannel)
	mux.HandleFunc("/instChannel/updateChannel", handler.updateChannel)
	mux.HandleFunc("/instChannel/adjustChannel", handler.adjustChannels)
	mux.HandleFunc("/instChannelCategory/getChannelCategoryList", handler.channelCategories)
	mux.HandleFunc("/instChannelCategory/saveCategory", handler.addChannelCategory)
	mux.HandleFunc("/instChannelCategory/updateCategory", handler.updateChannelCategory)
	mux.HandleFunc("/instChannelCategory/deleteCategory", handler.deleteChannelCategory)
	mux.HandleFunc("/instCourseCategory/getCourseCategoryPage", handler.courseCategoriesPage)
	mux.HandleFunc("/instCourseCategory/addCourseCategory", handler.addCourseCategory)
	mux.HandleFunc("/instCourseCategory/updateCourseCategory", handler.updateCourseCategory)
	mux.HandleFunc("/instCourseCategory/deleteCourseCategory", handler.deleteCourseCategory)
	mux.HandleFunc("/instCourse/getCoursePage", handler.coursesPage)
	mux.HandleFunc("/instCourse/getCourseIdAndName", handler.courseIDNamesPage)
	mux.HandleFunc("/instCourse/addCourse", handler.addCourse)
	mux.HandleFunc("/instCourse/updateCourse", handler.updateCourse)
	mux.HandleFunc("/instCourse/getCourseDetail", handler.courseDetail)
	mux.HandleFunc("/instCourse/getProcessContentPage", handler.processContentPage)
	mux.HandleFunc("/instCourse/batchDelOrResCourse", handler.batchDeleteOrRestoreCourses)
	mux.HandleFunc("/instCourse/batchSaleStatus", handler.batchSaleStatus)
	mux.HandleFunc("/instCourse/batchOpenMicroSchoolShow", handler.batchOpenMicroSchoolShow)
	mux.HandleFunc("/esSync/status", handler.infrastructureStatus)
	mux.HandleFunc("/mq/eventLogs", handler.mqEventLogs)
	mux.HandleFunc("/esSync/syncIntentStudent", handler.syncIntentStudents)
	mux.HandleFunc("/esSync/rebuildIntentStudent", handler.rebuildIntentStudents)
	mux.HandleFunc("/esSync/clearIntentStudent", handler.clearIntentStudents)
	mux.HandleFunc("/instStudent/getIntendedStudentPage", handler.intentStudentsPage)
	mux.HandleFunc("/instStudent/getIntentStudentDetail", handler.intentStudentDetail)
	mux.HandleFunc("/instStudent/getCurrentStudentPage", handler.currentStudentsPage)
	mux.HandleFunc("/instStudent/getEnrolledStudentPage", handler.enrolledStudentsPage)
	mux.HandleFunc("/saleOrder/getOrderList", handler.orderList)
	mux.HandleFunc("/saleOrder/getOrderDetail", handler.orderDetail)
	mux.HandleFunc("/saleOrder/checkQuoteInfo", handler.checkQuoteInfo)
	mux.HandleFunc("/saleOrder/calcCourseEnrollType", handler.calcCourseEnrollType)
	mux.HandleFunc("/saleOrder/createOrder", handler.createOrder)
	mux.HandleFunc("/saleOrder/payOrder", handler.payOrder)
	mux.HandleFunc("/saleOrder/getRegistrationListPage", handler.registrationListPage)
	mux.HandleFunc("/saleOrder/setBadDebt", handler.setBadDebt)
	mux.HandleFunc("/saleOrder/cancelBadDebt", handler.cancelBadDebt)
	mux.HandleFunc("/followRecord/getFollowUpRecordPaged", handler.followRecordsPage)
	mux.HandleFunc("/followRecord/createStudentFollowUp", handler.createFollowUp)
	mux.HandleFunc("/followRecord/getFollowUpCount", handler.followUpCount)
	mux.HandleFunc("/followRecord/updateVisitStatus", handler.updateVisitStatus)
	mux.HandleFunc("/followRecord/updateFollowRecord", handler.updateFollowUpRecord)
	mux.HandleFunc("/followRecord/getFollowUpRecordStatistics", handler.followUpRecordStatistics)
	mux.HandleFunc("/instStudent/getFollowUpCount", handler.followUpCount)
	mux.HandleFunc("/instStudent/updateStatus", handler.updateStudentStatus)
	mux.HandleFunc("/instStudent/batchAssignSalesperson", handler.batchAssignSalesperson)
	mux.HandleFunc("/instStudent/batchTransferToPublicPool", handler.batchTransferToPublicPool)
	mux.HandleFunc("/instStudent/batchDeleteIntendedStudent", handler.batchDeleteIntentStudents)
	mux.HandleFunc("/instStudent/addIntendedStudent", handler.addIntentStudent)
	mux.HandleFunc("/instStudent/updateIntendedStudent", handler.updateIntentStudent)
	mux.HandleFunc("/instStudent/checkStudentRepeat", handler.checkStudentRepeat)
	mux.HandleFunc("/instStudent/checkStudentTips", handler.checkStudentTips)
	mux.HandleFunc("/instStudent/getStudentPhoneNumber", handler.getStudentPhoneNumber)
	mux.HandleFunc("/instStudent/getRecommenderPage", handler.recommendersPage)
	mux.HandleFunc("/instStudent/getBirthdayStudent", handler.birthdayStudentsPage)
	...
	mux.HandleFunc("/instUser/updateInstUser", handler.updateInstUser)
	mux.HandleFunc("/instUser/batchDisabled", handler.batchDisabledInstUsers)
	mux.HandleFunc("/instUser/batchModifyDept", handler.batchModifyInstUserDept)
	mux.HandleFunc("/instUser/batchModifyRole", handler.batchModifyInstUserRole)
	mux.HandleFunc("/instUser/checkPhoneUsed", handler.checkInstUserPhoneUsed)
	mux.HandleFunc("/instUser/changePhoneWithOther", handler.changeInstUserPhone)
	mux.HandleFunc("/qiniuyun/getUpToken", handler.qiniuUploadToken)
	mux.HandleFunc("/qiniuyun/getVideoUploadToken", handler.qiniuVideoUploadToken)
	mux.HandleFunc("/TuitionAccount/GetTuitionAccountReadingList", handler.tuitionAccountReadingList)
	mux.HandleFunc("/instCourseProperty/getCoursePropertyList", handler.coursePropertyList)
