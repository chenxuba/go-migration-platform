...
func (handler *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/next-ordering/ToB/PC/LessonIncome/QueryPagedList", handler.lessonIncomeQueryPagedList)
	mux.HandleFunc("/next-ordering/ToB/PC/LessonIncome/GetStatistics", handler.lessonIncomeStatistics)
