...
func buildClassCommentWordDocument(items []rehabRecordWordExportView) string {
	...
	for _, item := range items {
		...
		builder.WriteString(`<td class="label date-label date-center" align="center" width="64" style="mso-width-source:userset;mso-width-alt:1280;width:64pt;white-space:nowrap;">出生年月</td><td class="date-center nowrap" align="center" width="93" style="mso-width-source:userset;mso-width-alt:1866;width:93.3pt;white-space:nowrap;">` + renderWordText(item.BirthDate) + `</td>`)
