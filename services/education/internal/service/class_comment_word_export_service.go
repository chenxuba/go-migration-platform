...
func buildClassCommentWordDocument(items []rehabRecordWordExportView) string {
	...
	for _, item := range items {
		...
		builder.WriteString(`<td class="label date-label date-center" align="center" width="56" style="mso-width-source:userset;mso-width-alt:1120;width:56pt;white-space:nowrap;">出生年月</td><td class="date-left nowrap" align="left" width="91" style="mso-width-source:userset;mso-width-alt:1820;width:91.3pt;white-space:nowrap;">` + renderWordText(item.BirthDate) + `</td>`)
		builder.WriteString(`<td class="label-multi" width="24" style="mso-width-source:userset;mso-width-alt:480;width:24pt;">班<br>别</td><td class="left class-name-cell" width="82" style="mso-width-source:userset;mso-width-alt:1640;width:82pt;">` + renderWordText(item.ClassName) + `</td>`)
		builder.WriteString(`</tr>`)
		builder.WriteString(`<tr>`)
