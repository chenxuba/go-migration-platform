...
func buildClassCommentWordDocument(items []rehabRecordWordExportView) string {
	...
	for _, item := range items {
		...
		builder.WriteString(`<table class="sheet"><colgroup><col width="42" style="mso-width-source:userset;mso-width-alt:840;width:42pt"><col width="56" style="mso-width-source:userset;mso-width-alt:1120;width:56pt"><col width="32" style="mso-width-source:userset;mso-width-alt:640;width:32pt"><col width="22" style="mso-width-source:userset;mso-width-alt:440;width:22pt"><col width="78" style="mso-width-source:userset;mso-width-alt:1560;width:78pt"><col width="87" style="mso-width-source:userset;mso-width-alt:1746;width:87.3pt"><col width="24" style="mso-width-source:userset;mso-width-alt:480;width:24pt"><col width="74" style="mso-width-source:userset;mso-width-alt:1480;width:74pt"></colgroup>`)
		builder.WriteString(`<tr>`)
		builder.WriteString(`<td class="label">姓名</td><td class="left" width="56" style="mso-width-source:userset;mso-width-alt:1120;width:56pt;">` + renderWordText(item.StudentName) + `</td>`)
		builder.WriteString(`<td class="label" width="32" style="mso-width-source:userset;mso-width-alt:640;width:32pt;">性别</td><td class="center" width="22" style="mso-width-source:userset;mso-width-alt:440;width:22pt;">` + renderWordText(item.Gender) + `</td>`)
		builder.WriteString(`<td class="label date-label date-center" align="center" width="78" style="mso-width-source:userset;mso-width-alt:1560;width:78pt;white-space:nowrap;">出生年月</td><td class="date-center nowrap" align="center" width="87" style="mso-width-source:userset;mso-width-alt:1746;width:87.3pt;white-space:nowrap;">` + renderWordText(item.BirthDate) + `</td>`)
