...
type PEP3IEPMaterialMatchCandidate struct {
	...
	CourseForm        string                    `json:"courseForm,omitempty"`
	TrainingMaterials []PEP3IEPTrainingMaterial `json:"trainingMaterials,omitempty"`
	AIInstruction     string                    `json:"aiInstruction,omitempty"`
}

type PEP3IEPMaterialMatchResult struct {
	RecordID       int64                           `json:"recordId,omitempty"`
	StudentName    string                          `json:"studentName,omitempty"`
	CandidateCount int                             `json:"candidateCount"`
	Candidates     []PEP3IEPMaterialMatchCandidate `json:"candidates"`
}
