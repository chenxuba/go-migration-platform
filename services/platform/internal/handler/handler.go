...
func (handler *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/rules/page", handler.platformPEP3IEPMaterialRulesPage)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/rules/save", handler.platformPEP3IEPMaterialRulesSave)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/rules/delete", handler.platformPEP3IEPMaterialRulesDelete)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/goals/page", handler.platformPEP3IEPMaterialGoalsPage)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/goals/save", handler.platformPEP3IEPMaterialGoalsSave)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/goals/delete", handler.platformPEP3IEPMaterialGoalsDelete)
	...
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/ai/batch-generate", handler.platformPEP3IEPMaterialAIBatchGenerate)
	...
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-uploaded-file", handler.platformPEP3IEPMaterialImportUploadedFile)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/submit", handler.platformPEP3IEPMaterialImportSubmit)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/detail", handler.platformPEP3IEPMaterialImportTaskDetail)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/list", handler.platformPEP3IEPMaterialImportTaskList)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/records", handler.platformPEP3IEPMaterialImportTaskRecords)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/batch-save-records", handler.platformPEP3IEPMaterialImportBatchSaveRecords)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/start", handler.platformPEP3IEPMaterialImportStart)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/clear", handler.platformPEP3IEPMaterialImportClear)
	mux.HandleFunc("/api/v1/platform/scales/pep3-iep-material/import-tasks/delete", handler.platformPEP3IEPMaterialImportDelete)
