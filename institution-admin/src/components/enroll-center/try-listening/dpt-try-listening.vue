...
const displayArray = ref(['intention', 'followStatus', 'sex', 'createUser', 'createTime', 'intentionCourse', 'reference', 'department'])
</script>

<template>
  <div class="tab-content">
    <all-filter :display-array="displayArray" type="dpt" :is-quick-show="false" :is-show-search-stu-phone="false" />
    <div class="tab-table">
      <div class="table-title flex justify-between">
        <div class="total">
          共 {{ dataSource.length }} 条，共 0 位学员
        </div>
        <div class="edit flex">
