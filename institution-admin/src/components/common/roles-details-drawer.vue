...
const isSuperAdminRoleName = computed(() => String(localDetails.value?.roleName || '').includes('超级管理员'))
      ...
      <div class="contenter">
        <div class="p-24px pb-0">
          <div class="flex justify-between items-center mb-10px">
            ...
            <a-button
              v-if="localDetails.isDefault != null"
              type="primary"
              :disabled="!canEditRole"
              :style="!canEditRole ? { pointerEvents: 'none' } : undefined"
