...
const reportList = [
  {
    ...
    popover_title: '开课次数', // 弹出框标题
    popover_content: '所选时间段内的开课总次数', // 弹出框内容
    chain: '', // 环比
    onYear: '', // 同比
  },
  {
  ...
  },
  {
    ...
    briefing: true,
    popover_title: '请假人次',
    popover_content: '所选时间段内请假的学员人次总数',
    chain: '',
    onYear: '',
  },
  {
    ...
    briefing: true,
    popover_title: '旷课人次',
    popover_content: '所选时间段内旷课的学员人次总数',
    chain: '',
    onYear: '',
  },
  {
  ...
  },
  {
    ...
    briefing: true,
    popover_title: '待补课人次',
    popover_content: '所选时间段内需要补课的学员人次总数',
    chain: '',
    onYear: '',
  },
  {
    ...
    briefing: true,
    popover_title: '已补课人次',
    popover_content: '所选时间段内已完成补课的学员人次总数',
    chain: '',
    onYear: '',
  },
  {
...
const dataTypeList = [
  ...
  },
  {
    ...
    value: 5,
    popover_title: '未记录人次',
    popover_content: '所选时间段内未记录考勤状态的学员人次总数',
  },
  {
    title: '学员出勤率',
    value: 6,
...
const allColumns = ref([
  ...
  {
    title: '老师授课课时',
    dataIndex: 'teacherClassHours',
    key: 'teacherClassHours',
    width: 160,
    sorter: (a, b) => a.teacherClassHours - b.teacherClassHours,
  },
  {
    title: '上课点名课时数',
