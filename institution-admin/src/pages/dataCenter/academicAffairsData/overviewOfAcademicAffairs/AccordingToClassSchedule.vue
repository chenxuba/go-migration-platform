...
const reportList = [
  {
    ...
    popover_title: '上课课程数量', // 弹出框标题
    popover_content: '所选时间段内的上课课程总数', // 弹出框内容
    chain: '', // 环比
    onYear: '', // 同比
  },
  {
...
const allColumns = ref([
  ...
  },
  {
    ...
    key: 'teachingMethod',
    width: 160,
    sorter: (a, b) => a.teachingMethod.localeCompare(b.teachingMethod),
  },
  {
    title: '已升期人数',
    dataIndex: 'promotedStudentCount',
    key: 'promotedStudentCount',
    width: 160,
    sorter: (a, b) => a.promotedStudentCount - b.promotedStudentCount,
  },
  {
    title: '升期率',
  ...
  {
    title: '计划课时课消',
    dataIndex: 'plannedHoursConsumption',
    key: 'plannedHoursConsumption',
    width: 160,
    sorter: (a, b) => a.plannedHoursConsumption - b.plannedHoursConsumption,
  },
  {
    title: '消耗课时数量',
