...
type ItemRecordField struct {
	...
	Options     []ItemRecordFieldOption `json:"options,omitempty"`
}

type ItemRecordFieldOption struct {
	Value string `json:"value"`
	Label string `json:"label"`
}

func ItemRecordFields(itemNo int) []ItemRecordField {
	fields := AllItemRecordFields()[itemNo]
	out := make([]ItemRecordField, 0, len(fields))
	for _, field := range fields {
		copied := field
		copied.Options = append([]ItemRecordFieldOption(nil), field.Options...)
		out = append(out, copied)
	}
	return out
}

func AllItemRecordFields() map[int][]ItemRecordField {
	return map[int][]ItemRecordField{
		5: {
		...
		58: {
			pep3MultiRecordField("catch_ball_attempts", "接球表现",
				pep3SameValueRecordFieldOption("第1次"),
				pep3SameValueRecordFieldOption("第2次"),
				pep3SameValueRecordFieldOption("第3次"),
			),
		},
		59: {
			pep3MultiRecordField("throw_ball_attempts", "抛球表现",
				pep3SameValueRecordFieldOption("第1次"),
				pep3SameValueRecordFieldOption("第2次"),
				pep3SameValueRecordFieldOption("第3次"),
			),
		...
		60: {
			pep3MultiRecordField("kick_ball_attempts", "踢球表现",
				pep3SameValueRecordFieldOption("第1次"),
				pep3SameValueRecordFieldOption("第2次"),
				pep3SameValueRecordFieldOption("第3次"),
			),
		...
		112: {
			pep3MultiRecordField("repeated_two_digits", "重复2个数字",
				pep3SameValueRecordFieldOption("7-9"),
				pep3SameValueRecordFieldOption("5-3"),
			),
		},
		113: {
			pep3MultiRecordField("repeated_three_digits", "重复3个数字",
				pep3SameValueRecordFieldOption("2-4-1"),
				pep3SameValueRecordFieldOption("5-7-9"),
			),
		},
		114: {
			pep3MultiRecordField("repeated_words", "重复2个字词",
				pep3SameValueRecordFieldOption("街街"),
				pep3SameValueRecordFieldOption("车车"),
				pep3SameValueRecordFieldOption("拜拜"),
			),
		},
		115: {
...
func pep3TextRecordField(key, label, placeholder string) ItemRecordField {
...
func pep3NumberRecordField(key, label, placeholder string) ItemRecordField {
	return ItemRecordField{
		Key:         key,
		Label:       label,
		FieldType:   "number",
...
func pep3TextareaRecordField(key, label, placeholder string) ItemRecordField {
	return ItemRecordField{
		Key:         key,
		Label:       label,
		FieldType:   "textarea",
...
func pep3RadioRecordField(key, label string, options ...ItemRecordFieldOption) ItemRecordField {
	return pep3ChoiceRecordField(key, label, "radio", options...)
}

func pep3DominanceRecordField(key, label string, options ...ItemRecordFieldOption) ItemRecordField {
	field := pep3ChoiceRecordField(key, label, "radio", options...)
	field.DisplayType = "选择"
	return field
}

func pep3MultiRecordField(key, label string, options ...ItemRecordFieldOption) ItemRecordField {
	return pep3ChoiceRecordField(key, label, "checkbox_group", options...)
}

func pep3ChoiceRecordField(key, label, fieldType string, options ...ItemRecordFieldOption) ItemRecordField {
	displayType := "填空"
	if fieldType == "radio" {
		displayType = "单选"
	}
...
func pep3RecordFieldOption(value, label string) ItemRecordFieldOption {
	return ItemRecordFieldOption{Value: value, Label: label}
}

func pep3SameValueRecordFieldOption(label string) ItemRecordFieldOption {
	return ItemRecordFieldOption{Value: label, Label: label}
}

func pep3PictureAnswerFields(prefix string, labels []string) []ItemRecordField {
	fields := make([]ItemRecordField, 0, len(labels))
...
func pep3PictureCheckRecordField(key, label string, labels []string) ItemRecordField {
	options := make([]ItemRecordFieldOption, 0, len(labels))
